...
/**
 * Componente para logging estructurado de operaciones de integridad criptográfica.
 * 
 ...
 * 
 * Incluye correlation IDs para rastreo de requests y contexto completo
 * para análisis forense de violaciones de integridad.
 */
@Component
public class IntegrityEventLogger {
     ...
     */
    public void logHashGeneration(String correlationId, UUID presupuestoId, String approvalHash,
                                  String executionHash, long durationMs, int partidasCount, String algorithm) {
     ...
     * @param algorithm Versión del algoritmo usado
     */
    public void logHashValidation(String correlationId, UUID presupuestoId, boolean success,
                                 long durationMs, String details, String algorithm) {
        Map<String, Object> logData = new HashMap<>();
        logData.put("component", "integrity-hash-service");
     ...
     * 
     * **CRITICAL LOG**: Este log debe ser monitoreado activamente ya que
     * indica posibles intentos de tampering o corrupción de datos.
     *
     * @param correlationId ID de correlación
    ...
    public void logIntegrityViolation(String correlationId, BudgetIntegrityViolationException exception,
        ...
        logData.put("presupuesto_id", exception.getPresupuestoId() != null 
                ? exception.getPresupuestoId().getValue().toString() : null);
