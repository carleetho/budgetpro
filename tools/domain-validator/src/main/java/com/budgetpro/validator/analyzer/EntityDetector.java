 ...
 * 
 * Busca clases finales en paquetes model/ que representan agregados raíz o
 * entidades.
 */
public class EntityDetector {
    ...
    private static final java.util.logging.Logger LOGGER = java.util.logging.Logger
            .getLogger(EntityDetector.class.getName());
     ...
     * 
     * @param domainPath Ruta al directorio domain/ (ej:
     *                   backend/src/main/java/com/budgetpro/domain)
     * @return Lista de nombres completos de clases detectadas (ej:
    ...
    public List<String> detectEntities(Path domainPath) {
        ...
        try {
            ...
            LOGGER.severe("Error scanning entities: " + e.getMessage());
        }
     ...
     * 
     * Criterios: - Clase final en paquete que contiene "model" - O clase con
     * comentario que menciona "Aggregate Root" o "Entity"
     */
    private String detectEntityInFile(File file) throws FileNotFoundException {
        ...
        for (ClassOrInterfaceDeclaration clazz : classes) {
            ...
            if (clazz.getComment().isPresent()) {
                ...
                if (comment.contains("aggregate root") || comment.contains("entity") || comment.contains("agregado")) {
                    return packageName + "." + clazz.getNameAsString();
                }
            }
        }
    ...
    /**
     * Detecta relaciones entre entidades basándose en campos que referencian otras
     * entidades.
     * 
    ...
    private boolean isDomainEntityType(String typeName) {
        ...
        Set<String> nonEntities = Set.of("String", "Integer", "Long", "Double", "BigDecimal", "Boolean", "LocalDate",
                "LocalDateTime", "UUID", "List", "Set", "Map");
