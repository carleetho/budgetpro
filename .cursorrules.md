...
### ⛔ PROHIBICIÓN ESTRICTA DE BYPASS

- **NUNCA** modifiques archivos de configuración (`axiom.config.yaml`, `.cursorrules`) o scripts de validación para saltar un bloqueo.
- **SIEMPRE** si un cambio es bloqueado por AXIOM o la Gobernanza, divide el trabajo en commits más pequeños o pide permiso al USER.
- **EL BYPASS ES UNA VIOLACIÓN CRÍTICA**: No uses `--no-verify` ni alteres los límites para "completar la tarea".
...
_Última actualización: 2026-01-30_
