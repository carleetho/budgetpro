...
class ExplotarInsumosPresupuestoUseCaseImplTest {
    ...
    void setUp() {
        ...
        partida1 = Partida.crearRaiz(
                PartidaId.from(partidaId1),
                presupuestoId,
                "01.01",
                "Partida A",
                "m³",
        ...
        partida2 = Partida.crearRaiz(
                PartidaId.from(partidaId2),
                presupuestoId,
                "01.02",
                "Partida B",
                "m²",
        ...
        // APU 1 con Cemento
        apu1 = APUSnapshot.crear(
                APUSnapshotId.of(UUID.randomUUID()),
                partidaId1,
                "APU-001",
                "CATALOG-001",
        ...
        APUInsumoSnapshot insumoCemento1 = APUInsumoSnapshot.crear(
                ...
                "BOL",
                "KG",
                new BigDecimal("42.5"), // 1 bolsa = 42.5 kg
                "BOL",
                "PEN",
                BigDecimal.ONE,
                new BigDecimal("22.50"), // precioMercado
        ...
        APUInsumoSnapshot insumoCemento2 = APUInsumoSnapshot.crear(
                APUInsumoSnapshotId.of(UUID.randomUUID()),
                "MAT-001",
                "Cemento",
                new BigDecimal("0.5"),
                ...
                "KG",
                "KG",
                BigDecimal.ONE, // Ya está en kg
                "KG",
                "PEN",
                BigDecimal.ONE,
                new BigDecimal("0.53"), // precioMercado
                BigDecimal.ZERO, // flete
    ...
    void deberiaExplotarInsumosConNormalizacionDeUnidades() {
        ...
        when(partidaRepository.findByPresupuestoId(presupuestoId))
        ...
        // En bolsas: 41,377.5 / 42.5 = 974.176... → 975 bolsas (redondeado hacia arriba con CEILING)
    ...
    void deberiaRechazarUnidadesIncompatibles() {
        ...
        APUInsumoSnapshot insumoIncompatible = APUInsumoSnapshot.crear(
                ...
                new BigDecimal("1.0"),
                "TON",
                "TON", // Diferente unidad base
                BigDecimal.ONE,
                "TON",
                "PEN",
                BigDecimal.ONE,
                new BigDecimal("1.0"), // precioMercado
                BigDecimal.ZERO, // flete
        ...
        APUSnapshot apuIncompatible = APUSnapshot.crear(
                APUSnapshotId.of(UUID.randomUUID()),
                partidaId2,
                "APU-003",
                "CATALOG-001",
