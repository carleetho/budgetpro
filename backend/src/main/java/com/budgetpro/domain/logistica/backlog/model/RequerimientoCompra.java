 ...
 * - El requisicionId (origen) es obligatorio
 * - El recursoExternalId no puede ser nulo o vacío
 * - La cantidadNecesaria debe ser positiva
...
public final class RequerimientoCompra {
    ...
    private RequerimientoCompra(RequerimientoCompraId id, UUID proyectoId, RequisicionId requisicionId,
                                String recursoExternalId, BigDecimal cantidadNecesaria, String unidadMedida,
                                PrioridadCompra prioridad, EstadoRequerimiento estado,
     ...
     */
    public static RequerimientoCompra reconstruir(RequerimientoCompraId id, UUID proyectoId, RequisicionId requisicionId,
                                                 String recursoExternalId, BigDecimal cantidadNecesaria, String unidadMedida,
                                                 PrioridadCompra prioridad, EstadoRequerimiento estado,
                                                 LocalDateTime fechaCreacion, LocalDateTime fechaActualizacion, Long version) {
        return new RequerimientoCompra(id, proyectoId, requisicionId, recursoExternalId, cantidadNecesaria,
    ...
    /**
     * Marca el requerimiento como recibido (cuando la compra llega y se registra en inventario).
     */
    ...
    public String toString() {
        return String.format("RequerimientoCompra{id=%s, proyectoId=%s, requisicionId=%s, recursoExternalId='%s', cantidadNecesaria=%s, prioridad=%s, estado=%s}",
