...
public final class MovimientoAlmacen {
    ...
    private MovimientoAlmacen(MovimientoAlmacenId id, AlmacenId almacenId, UUID recursoId,
            TipoMovimientoAlmacen tipoMovimiento, LocalDate fechaMovimiento, BigDecimal cantidad,
            BigDecimal precioUnitario, BigDecimal importeTotal, String numeroDocumento, UUID partidaId,
            UUID centroCostoId, String observaciones) {
    ...
    public static MovimientoAlmacen crearEntrada(MovimientoAlmacenId id, AlmacenId almacenId, UUID recursoId,
            LocalDate fechaMovimiento, BigDecimal cantidad, BigDecimal precioUnitario, String numeroDocumento,
            String observaciones) {
        BigDecimal importeTotal = cantidad.multiply(precioUnitario);
        return new MovimientoAlmacen(id, almacenId, recursoId, TipoMovimientoAlmacen.ENTRADA, fechaMovimiento, cantidad,
                precioUnitario, importeTotal, numeroDocumento, null, null, observaciones);
    }
    ...
    public static MovimientoAlmacen crearSalida(MovimientoAlmacenId id, AlmacenId almacenId, UUID recursoId,
            LocalDate fechaMovimiento, BigDecimal cantidad, BigDecimal precioUnitario, UUID partidaId,
            UUID centroCostoId, String numeroDocumento, String observaciones) {
        BigDecimal importeTotal = cantidad.multiply(precioUnitario);
        return new MovimientoAlmacen(id, almacenId, recursoId, TipoMovimientoAlmacen.SALIDA, fechaMovimiento, cantidad,
                precioUnitario, importeTotal, numeroDocumento, partidaId, centroCostoId, observaciones);
    }
    ...
    public static MovimientoAlmacen reconstruir(MovimientoAlmacenId id, AlmacenId almacenId, UUID recursoId,
            ...
            BigDecimal precioUnitario, BigDecimal importeTotal, String numeroDocumento, UUID partidaId,
            UUID centroCostoId, String observaciones) {
        return new MovimientoAlmacen(id, almacenId, recursoId, tipoMovimiento, fechaMovimiento, cantidad,
                precioUnitario, importeTotal, numeroDocumento, partidaId, centroCostoId, observaciones);
    }

    // Getters

    public MovimientoAlmacenId getId() {
        return id;
    }
