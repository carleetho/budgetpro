...
/**
 * Evento de dominio que se dispara cuando se ingresan fondos a una Billetera.
 */
public final class FondosIngresados implements DomainEvent {
    ...
    public FondosIngresados(BilleteraId billeteraId, Monto monto, String referencia, String evidenciaUrl) {
    ...
    public boolean equals(Object o) {
        ...
        FondosIngresados that = (FondosIngresados) o;
    ...
    public String toString() {
        return String.format("FondosIngresados{eventId=%s, billeteraId=%s, monto=%s, referencia='%s', occurredAt=%s}",
