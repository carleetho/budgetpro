...
public final class Presupuesto {
    ...
    /**
     * Factory method para crear un nuevo Presupuesto en estado EN_EDICION.
     */
    public static Presupuesto crear(PresupuestoId id, UUID proyectoId, String nombre) {
        return new Presupuesto(id, proyectoId, nombre, EstadoPresupuesto.EN_EDICION, false, 0L);
    }
    ...
    public boolean isAprobado() {
        return estado == EstadoPresupuesto.APROBADO;
    }
