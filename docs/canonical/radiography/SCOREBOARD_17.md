...
| ----- | ------ | --- | ----------------- | ---- | -------- | --------- |
| 1 | RRHH | 35 | Partial | P1 | [RRHH_MODULE_CANONICAL.md](../modules/RRHH_MODULE_CANONICAL.md) | pendiente |
| 2 | Producción | 55 | Functional | P2 | [PRODUCCION_MODULE_CANONICAL.md](../modules/PRODUCCION_MODULE_CANONICAL.md) | pendiente |
